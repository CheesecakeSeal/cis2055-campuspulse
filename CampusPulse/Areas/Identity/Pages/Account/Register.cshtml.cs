...
namespace CampusPulse.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^[A-Za-z0-9_-]{3,30}$", ErrorMessage = "Display name can only contain letters, numbers, underscores, and hyphens.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, UserRoles.Reporter);
